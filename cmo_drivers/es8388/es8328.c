...
static const struct snd_kcontrol_new es8328_left_monomux_controls =
    SOC_DAPM_ENUM("Route", monomux);
static const struct snd_kcontrol_new es8328_right_monomux_controls =
    SOC_DAPM_ENUM("Route", monomux);
static const struct snd_soc_dapm_widget es8328_dapm_widgets[] = {
	SND_SOC_DAPM_MUX("Differential Mux", SND_SOC_NOPM, 0, 0,
		&es8328_diffmux_controls),
	SND_SOC_DAPM_MUX("Left ADC Mux", SND_SOC_NOPM, 0, 0,
		&es8328_left_monomux_controls),
	SND_SOC_DAPM_MUX("Right ADC Mux", SND_SOC_NOPM, 0, 0,
		&es8328_right_monomux_controls),
	...
	SND_SOC_DAPM_ADC("Right ADC", "Capture", ES8328_ADCPOWER,
			ES8328_ADCPOWER_ADCR_OFF, 1),
	SND_SOC_DAPM_ADC("Left ADC", "Capture", ES8328_ADCPOWER,
	...
	SND_SOC_DAPM_DAC("Right DAC", "Playback", ES8328_DACPOWER,
			ES8328_DACPOWER_RDAC_OFF, 1),
	SND_SOC_DAPM_DAC("Left DAC", "Playback", ES8328_DACPOWER,
...
static const struct snd_soc_dapm_route es8328_dapm_routes[] = {
	...
	{ "Left ADC",  NULL, "Mic Bias Gen" },
        { "Right ADC", NULL, "Mic Bias Gen" },
...
static int es8328_component_probe(struct snd_soc_component *component)
{
	...
	if (ret) {
		...
		goto clk_fail;
         ...
         /* ES8388: ADC and DAC share the same LRCK */
	snd_soc_component_update_bits(component, 0x2b, 0x80, 0x80);
	return 0;
